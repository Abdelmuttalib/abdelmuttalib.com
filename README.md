...
> A minimal, highly customizable, and performant personal abdelmuttalib template built with Astro, React, and Tailwind CSS.

![OscarHernandez-abdelmuttalib](https://github.com/user-attachments/assets/e284a42b-15c5-495c-99c7-ad5c1eb3bbe7)
![Deploy Status](https://img.shields.io/badge/Deploy-Vercel-black?style=flat&logo=vercel)

---

[Demo](https://abdelmuttalib.vercel.app/) | [Astro Themes](https://astro.build/themes/details/dark-minimal/) | [ReactBits Showcase](https://www.reactbits.dev/showcase)
...
```html
<iframe
  src="https://open.spotify.com/embed/album/YOUR_ALBUM_ID_HERE"
...
```html
<form action="https://formspree.io/f/YOUR_FORM_ID_HERE" method="POST"></form>
```

## **Customization**

To make this abdelmuttalib your own, you can edit the following files:
...
```bash
git clone https://github.com/Abdelmuttalib/Astro-abdelmuttalib
```
...
> notice and the full license text. Copyright © 2026 Abdelmuttalib Ahmed. All rights reserved.
