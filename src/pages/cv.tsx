...
export default function CVPage() {
  return (
    <>
      ...
      <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16 dark:bg-background print:bg-background">
        <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:bg-background dark:bg-transparent print:space-y-6">
